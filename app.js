...
// ===== PATCH iOS SAFETY =====
// Evita errores si no existen nodos/funciones al arrancar
window.playClick = window.playClick || function() {};
window.showSettings = window.showSettings || function() {
    const app = document.getElementById("app");
    if (app) {
        app.innerHTML = `<div class="card"><h2>Ajustes</h2><p>Panel de ajustes cargado correctamente.</p></div>`;
    }
};
